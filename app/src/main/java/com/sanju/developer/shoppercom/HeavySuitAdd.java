...
public class HeavySuitAdd extends AppCompatActivity {
    ...
    private Uri imguri;
    ProgressDialog Pd;
    public static final String FB_STOARAGE_PATH="heavysuit/";
    public static final String FB_DATABASE_PATH="heavysuit";
