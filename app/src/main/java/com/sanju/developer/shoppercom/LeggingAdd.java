...
public class LeggingAdd extends AppCompatActivity {
    ...
    private Uri imguri;
    ProgressDialog Pd;
    public static final String FB_STOARAGE_PATH="legging/";
    public static final String FB_DATABASE_PATH="legging";
