...
public class SuitPrintAdd extends AppCompatActivity {
    ...
    private Uri imguri;
    ProgressDialog Pd;
    public static final String FB_STOARAGE_PATH="suitprint/";
    public static final String FB_DATABASE_PATH="suitprint";
